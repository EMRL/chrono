Localization.define('en_US') do |l|
  ...
  l.store "%d more", ["%d more", "%d more"] # Erlend Simonsen
  l.store "%d week", ["one week", "%d weeks"] # Erlend Simonsen
  l.store "%d month", ["one month", "%d months"] # Erlend Simonsen
  l.store "%d posts", ["%d posts", "%d posts"]
  l.store "%d folder", ["one folder", "%d folders"]
  l.store "%d minute", ["one minute", "%d minutes"] # Erlend Simonsen
  ...
  l.store "over %d years", ["over %d years", "over %d years"]
