...
Rails::Initializer.run do |config|
  ...
  # Make Active Record use UTC-base instead of local time (:local or :utc)
  #
  #
  #
  #
...
# -- Configuration
#These settings affect how notification emails appear, see app/models/notifications.rb
$CONFIG = { :domain => "emrl.com",
	    :replyto => "projects",
	    :from => "projects",
	    :prefix => "[EMRL]"
}
