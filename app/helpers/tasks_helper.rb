module TasksHelper
  ...
  def print_title
    ...
    title << "]</span><span style=\"float:right\">#{tz.now.strftime_localized("#{current_user.time_format} #{current_user.date_format}")}</span><span style=\"display:block;clear:both\"></span>"
